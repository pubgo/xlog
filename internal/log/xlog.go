...
func (log *xlog) Warning(msg string, fields ...internal.Field) { log.Warn(msg, fields...) }
func (log *xlog) Debug(msg string, fields ...internal.Field)   { log.zl.Debug(msg, fields...) }
func (log *xlog) Info(msg string, fields ...internal.Field)    { log.zl.Info(msg, fields...) }
func (log *xlog) Warn(msg string, fields ...internal.Field)    { log.zl.Warn(msg, fields...) }
func (log *xlog) Error(msg string, fields ...internal.Field)   { log.zl.Error(msg, fields...) }
func (log *xlog) DPanic(msg string, fields ...internal.Field)  { log.zl.DPanic(msg, fields...) }
func (log *xlog) Panic(msg string, fields ...internal.Field)   { log.zl.Panic(msg, fields...) }
func (log *xlog) Fatal(msg string, fields ...internal.Field)   { log.zl.Fatal(msg, fields...) }
func (log *xlog) With(fields ...zap.Field) internal.XLog       { return &xlog{log.zl.With(fields...)} }
