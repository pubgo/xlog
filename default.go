...
var defaultLog = func() *log.XLog { return GetDevLog().Named("debug", zap.AddCallerSkip(1)).(*log.XLog) }()
...
func Debug(msg string, fields ...internal.Field)       { GetDefault().Debug(msg, fields...) }
...
func Info(msg string, fields ...internal.Field)        { GetDefault().Info(msg, fields...) }
func Warn(msg string, fields ...internal.Field)        { GetDefault().Warn(msg, fields...) }
func Error(msg string, fields ...internal.Field)       { GetDefault().Error(msg, fields...) }
func DPanic(msg string, fields ...internal.Field)      { GetDefault().DPanic(msg, fields...) }
func Panic(msg string, fields ...internal.Field)       { GetDefault().Panic(msg, fields...) }
func Fatal(msg string, fields ...internal.Field)       { GetDefault().Fatal(msg, fields...) }
func With(fields ...zap.Field) internal.XLog           { return GetDefault().With(fields...) }
func Named(s string, opts ...zap.Option) internal.XLog { return GetDefault().Named(s, opts...) }
